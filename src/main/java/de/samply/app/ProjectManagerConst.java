...
public class ProjectManagerConst {
    ...
    public final static String UPLOAD_FORM_FIELD_ACTION = "UPLOAD_FORM_FIELD";
    ...
    public final static String ADD_FORM_FIELD_URL_ACTION = "ADD_FORM_FIELD_URL";
    public final static String DOWNLOAD_DESCRIPTION_ACTION = "DOWNLOAD_DESCRIPTION";
    public final static String DOWNLOAD_FORM_FIELD_ACTION = "DOWNLOAD_FORM_FIELD";
    ...
    public final static String EXISTS_FORM_FIELD_ACTION = "EXISTS_FORM_FIELD";
    ...
    public final static String REMOVE_USER_FROM_MAILING_BLACK_LIST = "/mailing-black-list";
    ...
    public final static String ACCEPT_BRIDGEHEAD_PROJECT = "/project/bridgehead/accept";
    public final static String REJECT_BRIDGEHEAD_PROJECT = "/project/bridgehead/reject";
    public final static String ACCEPT_SCRIPT = "/script/accept";
    public final static String REJECT_SCRIPT = "/script/reject";
    public final static String REQUEST_SCRIPT_CHANGES = "/script/request-changes";
    public final static String ACCEPT_PROJECT_RESULTS = "/project/results/accept";
    public final static String REJECT_PROJECT_RESULTS = "/project/results/reject";
    public final static String REQUEST_CHANGES_IN_PROJECT = "/project/request-changes";
    public final static String ACCEPT_PROJECT_ANALYSIS = "/project/analysis/accept";
    ...
    public final static String IS_FEASIBILITY_ENABLED = "/feasibility/enabled";
    ...
    public final static String START_FINAL_STAGE = "/project/start-final";
    public final static String FINISH_PROJECT = "/project/finish";
    public final static String CREATE_QUERY = "/query";
    ...
    public final static String UPLOAD_FORM_FIELD = "/project/form/field/upload";
    ...
    public final static String ADD_FORM_FIELD_URL = "/project/form/field/url";
    ...
    public final static String DOWNLOAD_FORM_FIELD = "/project/form/field/download";
    ...
    public final static String EXISTS_FORM_FIELD = "/project/form/field/exists";
    ...
    public final static String DOWNLOAD_OTHER_DOCUMENT = "/other-document/download";
    ...
    public final static String ACCEPT_PROJECT_RESULTS_URL = "/project/results/accept-url";
    public final static String REJECT_PROJECT_RESULTS_URL = "/project/results/reject-url";
    public final static String FETCH_PROJECT_RESULTS = "/project/results";
    public final static String REQUEST_CHANGES_IN_PROJECT_RESULTS_URL = "/project/results/url/request-changes";
    public final static String ACCEPT_PROJECT_BRIDGEHEAD_RESULTS_URL = "/project/bridgehead/results/url/accept";
    public final static String REJECT_PROJECT_BRIDGEHEAD_RESULTS_URL = "/project/bridgehead/results/url/reject";
    public final static String REQUEST_CHANGES_IN_PROJECT_BRIDGEHEAD_RESULTS_URL = "/project/bridgehead/results/url/request-changes";
    public final static String FETCH_PROJECT_BRIDGEHEAD_RESULTS = "/project/bridgehead/results";
    public final static String FETCH_PROJECT_BRIDGEHEAD_RESULTS_FOR_OWN_BRIDGEHEAD = "/project/bridgeheads/own/results";
    ...
    public final static String WEBCLIENT_REQUEST_TIMEOUT_IN_SECONDS_SV =
            HEAD_SV + WEBCLIENT_REQUEST_TIMEOUT_IN_SECONDS + ":30" + BOTTOM_SV;
    public final static String WEBCLIENT_CONNECTION_TIMEOUT_IN_SECONDS_SV =
            HEAD_SV + WEBCLIENT_CONNECTION_TIMEOUT_IN_SECONDS + ":5" + BOTTOM_SV;
    public final static String WEBCLIENT_TCP_KEEP_IDLE_IN_SECONDS_SV =
            HEAD_SV + WEBCLIENT_TCP_KEEP_IDLE_IN_SECONDS + ":60" + BOTTOM_SV;
    public final static String WEBCLIENT_TCP_KEEP_INTERVAL_IN_SECONDS_SV =
            HEAD_SV + WEBCLIENT_TCP_KEEP_INTERVAL_IN_SECONDS + ":10" + BOTTOM_SV;
    public final static String WEBCLIENT_TCP_KEEP_CONNECTION_NUMBER_OF_TRIES_SV =
            HEAD_SV + WEBCLIENT_TCP_KEEP_CONNECTION_NUMBER_OF_TRIES + ":5" + BOTTOM_SV;
