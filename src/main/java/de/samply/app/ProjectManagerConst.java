...
public class ProjectManagerConst {
    ...
    public final static String FETCH_VOTUM_LABEL_ACTION = "FETCH_VOTUM_LABEL";
    ...
    public final static String FETCH_APPLICATION_FORM_LABEL_ACTION = "FETCH_APPLICATION_FORM_LABEL";
    ...
    public final static String FETCH_SCRIPT_LABEL_ACTION = "FETCH_SCRIPT_LABEL";
    ...
    public final static String FETCH_VOTUM_LABEL = "/votum-label";
    ...
    public final static String FETCH_APPLICATION_FORM_LABEL = "/application-form-label";
    ...
    public final static String FETCH_SCRIPT_LABEL = "/script-label";
