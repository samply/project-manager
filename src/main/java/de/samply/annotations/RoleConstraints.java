...
public @interface RoleConstraints {
    ...
    /*
     Organisation Roles are checked in SecurityConfiguration. At this level, project code is not available yet,
    ...
    // Project Role are checked in ProjectRoleConstraintAspects
