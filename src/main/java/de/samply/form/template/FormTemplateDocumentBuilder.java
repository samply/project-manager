...
import de.samply.form.template.FormTemplateDocument.BlockHeading;
import de.samply.form.template.FormTemplateDocument.CheckBoxList;
import de.samply.form.template.FormTemplateDocument.CheckBoxOption;
import de.samply.form.template.FormTemplateDocument.FieldRow;
import de.samply.form.template.FormTemplateDocument.GroupHeading;
import de.samply.form.template.FormTemplateDocument.Node;
import de.samply.form.template.FormTemplateDocument.SectionHeading;
...
import de.samply.frontend.dto.FormFieldValue;
...
public final class FormTemplateDocumentBuilder {
    ...
    private static CheckBoxOption createOption(String fieldKey, FormFieldValue value, boolean checked) {
